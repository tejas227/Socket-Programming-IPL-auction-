...
public class team2 extends JFrame implements ActionListener, Runnable{
    JPanel p1;
    JTextField t1;
    JButton b1;
    JTextArea a1;
    ...
    team2(){
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("auction/csk.png"));
        ...
        b1.setBackground(new Color(29, 65, 140));
