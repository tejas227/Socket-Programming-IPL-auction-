...
public class team4 extends JFrame implements ActionListener, Runnable{
    JPanel p1;
    JTextField t1;
    JButton b1;
    JTextArea a1;
    ...
    team4(){
        ImageIcon i1 = new ImageIcon(ClassLoader.getSystemResource("auction/rcb.png"));
        ...
        b1.setBackground(new Color(236, 28, 36));
        b1.addActionListener(this);
        add(b1);
        
        a1 = new JTextArea();
        a1.setBounds(5,200,400,380);
        a1.setBackground(new Color(250, 223, 141));
